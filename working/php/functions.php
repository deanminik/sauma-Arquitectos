...
define('MFN_THEME_VERSION', '24.0.3.1');
...
wp_enqueue_style ('theme-style', get_template_directory_uri() . '/css/scss/arweb.css');
// wp_enqueue_script('custom', get_stylesheet_directory_uri() . '/js/custom.js?v='.SCRIPT_VERSION);
